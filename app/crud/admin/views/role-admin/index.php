...
/* @var $searchModel orm\admin\search\SearchRoleAdmin */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Role Admins';
...
<div class="crud-page-header page-header">
	<div class="btn-group btn-group-sm" style="float:right;">
		<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_BUTTONS, new CrudEvent(['modelClass' => 'orm\admin\RoleAdmin'])); ?>
...
<?php
	...
	Yii::$app->trigger(CrudEvent::RENDER_INDEX_BEFORE_GRID, new CrudEvent([
		'modelClass' => 'orm\admin\RoleAdmin', 
...
<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_AFTER_GRID, new CrudEvent(['modelClass' => 'orm\admin\RoleAdmin', 'dataProvider' => $dataProvider, 'columns' => $columns])); ?>
