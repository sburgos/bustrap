...
/* @var $searchModel orm\admin\search\SearchRoleRestPermit */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Role Rest Permits';
...
<div class="crud-page-header page-header">
	<div class="btn-group btn-group-sm" style="float:right;">
		<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_BUTTONS, new CrudEvent(['modelClass' => 'orm\admin\RoleRestPermit'])); ?>
...
<?php
	...
	Yii::$app->trigger(CrudEvent::RENDER_INDEX_BEFORE_GRID, new CrudEvent([
		'modelClass' => 'orm\admin\RoleRestPermit', 
...
<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_AFTER_GRID, new CrudEvent(['modelClass' => 'orm\admin\RoleRestPermit', 'dataProvider' => $dataProvider, 'columns' => $columns])); ?>
