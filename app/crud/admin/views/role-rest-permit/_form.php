...
if (!isset($formAction)) {
	if ($model->isNewRecord)
		$formAction = ['/admin/crud/role-rest-permit/create'];
	else {
		$formAction = ['/admin/crud/role-rest-permit/update'];
...
?>
	...
	<?php if (in_array('type', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'type')->dropDownList([
			\orm\admin\RoleRestPermit::TYPE_ALLOW => 'Allow',
			\orm\admin\RoleRestPermit::TYPE_DENY => 'Deny',
