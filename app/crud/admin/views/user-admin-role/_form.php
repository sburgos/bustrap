...
if (!isset($formAction)) {
	if ($model->isNewRecord)
		$formAction = ['/admin/crud/user-admin-role/create'];
	else {
		$formAction = ['/admin/crud/user-admin-role/update'];
...
?>
	...
	<?php if (in_array('userAdminId', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'userAdminId')->textInput() ?>
	<?php if (in_array('userAdminId', $hiddenColumns)) echo "</div>"; ?>
