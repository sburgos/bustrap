...
$this->title = 'User Admin Role' . ": " . $model->;
...
<div class="crud-page-header page-header">
	<div class="btn-group btn-group-sm" style="float:right;">
		...
		<?= Html::aACL('Edit', ['update', 'userAdminId' => $model->userAdminId, 'roleAdminId' => $model->roleAdminId], ['class' => 'btn btn-primary']) ?>
        <?= Html::aACL('Delete', ['delete', 'userAdminId' => $model->userAdminId, 'roleAdminId' => $model->roleAdminId], [
...
<?php
	...
	else
	{
		...
		<div class="crud-page-header page-header">
			<div class="btn-group btn-group-sm" style="float:right;">
			<?php
			echo Html::aACL('Edit', [$urlPath . '/update', 'userAdminId' => $model->userAdminId, 'roleAdminId' => $model->roleAdminId], ['class' => 'btn btn-primary']);
	        echo Html::aACL('Delete', [$urlPath . '/delete', 'userAdminId' => $model->userAdminId, 'roleAdminId' => $model->roleAdminId], [
	            'class' => 'btn btn-danger',
	            'data' => [
	                'confirm' => 'Are you sure you want to delete this item?',
	                'method' => 'post',
