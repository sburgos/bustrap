...
<?php
	...
	else
	{
		...
		<div class="crud-page-header page-header">
			<div class="btn-group btn-group-sm" style="float:right;">
			<?php
			echo Html::aACL('Edit', [$urlPath . '/update', 'restClientId' => $model->restClientId, 'roleRestId' => $model->roleRestId], ['class' => 'btn btn-primary']);
	        echo Html::aACL('Delete', [$urlPath . '/delete', 'restClientId' => $model->restClientId, 'roleRestId' => $model->roleRestId], [
	            'class' => 'btn btn-danger',
	            'data' => [
	                'confirm' => 'Are you sure you want to delete this item?',
	                'method' => 'post',
