...
if (!isset($formAction)) {
	if ($model->isNewRecord)
		$formAction = ['/admin/crud/user-admin-session/create'];
	else {
		$formAction = ['/admin/crud/user-admin-session/update'];
...
?>
	...
	<?php if (in_array('expire', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'expire')->textInput() ?>
	<?php if (in_array('expire', $hiddenColumns)) echo "</div>"; ?>

	<?php if (in_array('data', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'data')->textInput() ?>
	<?php if (in_array('data', $hiddenColumns)) echo "</div>"; ?>
