...
/* @var $searchModel orm\admin\search\SearchUserAdminSession */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'User Admin Sessions';
...
<div class="crud-page-header page-header">
	<div class="btn-group btn-group-sm" style="float:right;">
		<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_BUTTONS, new CrudEvent(['modelClass' => 'orm\admin\UserAdminSession'])); ?>
...
<?php
	...
	Yii::$app->trigger(CrudEvent::RENDER_INDEX_BEFORE_GRID, new CrudEvent([
		'modelClass' => 'orm\admin\UserAdminSession', 
...
<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_AFTER_GRID, new CrudEvent(['modelClass' => 'orm\admin\UserAdminSession', 'dataProvider' => $dataProvider, 'columns' => $columns])); ?>
