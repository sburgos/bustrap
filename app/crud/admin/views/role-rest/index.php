...
/* @var $searchModel orm\admin\search\SearchRoleRest */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Role Rests';
...
<div class="crud-page-header page-header">
	<div class="btn-group btn-group-sm" style="float:right;">
		<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_BUTTONS, new CrudEvent(['modelClass' => 'orm\admin\RoleRest'])); ?>
...
<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_AFTER_GRID, new CrudEvent(['modelClass' => 'orm\admin\RoleRest', 'dataProvider' => $dataProvider, 'columns' => $columns])); ?>
