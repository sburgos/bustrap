...
use orm\admin\search\SearchRoleAdmin;
...
/**
 * RoleAdminController implements the CRUD actions for RoleAdmin model.
 */
class RoleAdminController extends Controller
{
    ...
    /**
     * Lists all RoleAdmin models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new SearchRoleAdmin();
    ...
    /**
     * Displays a single RoleAdmin model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing RoleAdmin model.
    ...
    /**
     * Deletes an existing RoleAdmin model.
    ...
    /**
     * Finds the RoleAdmin model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return RoleAdmin the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = RoleAdmin::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    {
		$labelFields = explode(",", RoleAdmin::$__AJAX_LABEL_FIELDS_COMMA_SEPARATED);
		$labelFormat = RoleAdmin::$__AJAX_LABEL_FORMAT;
