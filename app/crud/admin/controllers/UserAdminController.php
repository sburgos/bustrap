...
use orm\admin\search\SearchUserAdmin;
...
class UserAdminController extends Controller
{
    ...
    {
        $searchModel = new SearchUserAdmin();
    ...
    {
		$labelFields = explode(",", UserAdmin::$__AJAX_LABEL_FIELDS_COMMA_SEPARATED);
		$labelFormat = UserAdmin::$__AJAX_LABEL_FORMAT;
