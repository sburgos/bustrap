...
use Yii;
use orm\admin\RoleRestPermit;
use orm\admin\search\SearchRoleRestPermit;
...
/**
 * RoleRestPermitController implements the CRUD actions for RoleRestPermit model.
 */
class RoleRestPermitController extends Controller
{
    ...
    /**
     * Lists all RoleRestPermit models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new SearchRoleRestPermit();
    ...
    /**
     * Displays a single RoleRestPermit model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new RoleRestPermit model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new RoleRestPermit();
    ...
    /**
     * Updates an existing RoleRestPermit model.
    ...
    /**
     * Deletes an existing RoleRestPermit model.
    ...
    /**
     * Finds the RoleRestPermit model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return RoleRestPermit the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = RoleRestPermit::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    {
		$labelFields = explode(",", RoleRestPermit::$__AJAX_LABEL_FIELDS_COMMA_SEPARATED);
		$labelFormat = RoleRestPermit::$__AJAX_LABEL_FORMAT;
		
    	$rows = [];
    	if ($term !== null)
    	{
    		$qry = RoleRestPermit::find();
