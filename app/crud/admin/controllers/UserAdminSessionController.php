...
use orm\admin\search\SearchUserAdminSession;
...
/**
 * UserAdminSessionController implements the CRUD actions for UserAdminSession model.
 */
class UserAdminSessionController extends Controller
{
    ...
    /**
     * Lists all UserAdminSession models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new SearchUserAdminSession();
    ...
    /**
     * Displays a single UserAdminSession model.
     * @param string $id
     * @return mixed
     */
    ...
    /**
     * Creates a new UserAdminSession model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new UserAdminSession();
    ...
    /**
     * Updates an existing UserAdminSession model.
    ...
    /**
     * Deletes an existing UserAdminSession model.
    ...
    /**
     * Finds the UserAdminSession model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param string $id
     * @return UserAdminSession the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = UserAdminSession::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    {
		$labelFields = explode(",", UserAdminSession::$__AJAX_LABEL_FIELDS_COMMA_SEPARATED);
		$labelFormat = UserAdminSession::$__AJAX_LABEL_FORMAT;
		
    	$rows = [];
    	if ($term !== null)
    	{
    		$qry = UserAdminSession::find();
