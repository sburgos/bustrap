...
if (!isset($formAction)) {
	if ($model->isNewRecord)
		$formAction = ['/event/crud/assistant/create'];
	else {
		$formAction = ['/event/crud/assistant/update'];
...
?>
	...
	<?php if (in_array('dni', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'dni')->textInput(['maxlength' => 8]) ?>
	<?php if (in_array('dni', $hiddenColumns)) echo "</div>"; ?>
