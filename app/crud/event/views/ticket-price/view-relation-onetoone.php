...
<div class="crud-page-header page-header">
	<div class="btn-group btn-group-sm" style="float:right;">
		...
		<?= Html::aACL('Edit', ['update', 'id' => $model->ticketId], ['class' => 'btn btn-primary']) ?>
        <?= Html::aACL('Delete', ['delete', 'id' => $model->ticketId], [
...
<?php
	...
	else
	{
		...
		<div class="crud-page-header page-header">
			<div class="btn-group btn-group-sm" style="float:right;">
			<?php
			echo Html::aACL('Edit', [$urlPath . '/update', 'id' => $model->ticketId], ['class' => 'btn btn-primary']);
	        echo Html::aACL('Delete', [$urlPath . '/delete', 'id' => $model->ticketId], [
	            'class' => 'btn btn-danger',
	            'data' => [
	                'confirm' => 'Are you sure you want to delete this item?',
	                'method' => 'post',
