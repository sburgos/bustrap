...
if (!isset($formAction)) {
	if ($model->isNewRecord)
		$formAction = ['/event/crud/manager/create'];
	else {
		$formAction = ['/event/crud/manager/update'];
...
?>
	...
	<?php if (in_array('email', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'email')->textInput(['maxlength' => 45]) ?>
	<?php if (in_array('email', $hiddenColumns)) echo "</div>"; ?>

	<?php if (in_array('phone', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'phone')->textInput(['maxlength' => 45]) ?>
	<?php if (in_array('phone', $hiddenColumns)) echo "</div>"; ?>

	<?php if (in_array('address', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'address')->textInput(['maxlength' => 200]) ?>
	<?php if (in_array('address', $hiddenColumns)) echo "</div>"; ?>
