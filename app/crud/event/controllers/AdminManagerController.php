...
use orm\event\search\SearchAdminManager;
...
class AdminManagerController extends Controller
{
    ...
    {
        $searchModel = new SearchAdminManager();
    ...
    {
		$labelFields = explode(",", AdminManager::$__AJAX_LABEL_FIELDS_COMMA_SEPARATED);
		$labelFormat = AdminManager::$__AJAX_LABEL_FORMAT;
		
    	$rows = [];
    	if ($term !== null)
    	{
    		$qry = AdminManager::find();
