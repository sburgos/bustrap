...
use orm\bus\search\SearchSmartNode;
...
/**
 * SmartNodeController implements the CRUD actions for SmartNode model.
 */
class SmartNodeController extends Controller
{
    ...
    /**
     * Lists all SmartNode models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new SearchSmartNode();
    ...
    /**
     * Displays a single SmartNode model.
     * @param integer $id
     * @return mixed
     */
	...
	/**
	 * Tab for viewing Datas for a single model
	 *
     * @param integer $id
     * @return mixed
	 */
	public function actionViewDatas($id)
	{
		$model = $this->findModel($id);
		return $this->render('view-relation', [
            ...
            'relationName' => 'Datas',
            'refClass' => 'Data',
            'parentColumns' => ['idSmartNode', 'smartNode'],
            'refColumns' => [
    'idSmartNode' => 'id',
],
            'dataProvider' => new \yii\data\ActiveDataProvider([
            	'query' => $model->getDatas(),
            ]),
            'oneToOne' => false,
        ]);
	}
    ...
    /**
     * Updates an existing SmartNode model.
    ...
    /**
     * Deletes an existing SmartNode model.
    ...
    /**
     * Finds the SmartNode model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return SmartNode the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = SmartNode::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    {
		$labelFields = explode(",", SmartNode::$__AJAX_LABEL_FIELDS_COMMA_SEPARATED);
		$labelFormat = SmartNode::$__AJAX_LABEL_FORMAT;
