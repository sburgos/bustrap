...
use orm\bus\search\SearchSmartRoutes;
...
/**
 * SmartRoutesController implements the CRUD actions for SmartRoutes model.
 */
class SmartRoutesController extends Controller
{
    ...
    /**
     * Lists all SmartRoutes models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new SearchSmartRoutes();
    ...
    /**
     * Displays a single SmartRoutes model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new SmartRoutes model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new SmartRoutes();
    ...
    /**
     * Updates an existing SmartRoutes model.
    ...
    /**
     * Deletes an existing SmartRoutes model.
    ...
    /**
     * Finds the SmartRoutes model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return SmartRoutes the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = SmartRoutes::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    {
		$labelFields = explode(",", SmartRoutes::$__AJAX_LABEL_FIELDS_COMMA_SEPARATED);
		$labelFormat = SmartRoutes::$__AJAX_LABEL_FORMAT;
		
    	$rows = [];
    	if ($term !== null)
    	{
    		$qry = SmartRoutes::find();
