...
/* @var $searchModel orm\bus\search\SearchInvitados */
...
<div class="crud-page-header page-header">
	<div class="btn-group btn-group-sm" style="float:right;">
		<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_BUTTONS, new CrudEvent(['modelClass' => 'orm\bus\Invitados'])); ?>
...
<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_AFTER_GRID, new CrudEvent(['modelClass' => 'orm\bus\Invitados', 'dataProvider' => $dataProvider, 'columns' => $columns])); ?>
