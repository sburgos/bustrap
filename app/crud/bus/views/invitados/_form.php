...
if (!isset($formAction)) {
	if ($model->isNewRecord)
		$formAction = ['/bus/crud/invitados/create'];
	else {
		$formAction = ['/bus/crud/invitados/update'];
...
?>
	...
	<?php if (in_array('nombre', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'nombre')->textInput(['maxlength' => 200]) ?>
	<?php if (in_array('nombre', $hiddenColumns)) echo "</div>"; ?>

	<?php if (in_array('correo', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'correo')->textInput(['maxlength' => 200]) ?>
	<?php if (in_array('correo', $hiddenColumns)) echo "</div>"; ?>

	<?php if (in_array('skype', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'skype')->textInput(['maxlength' => 200]) ?>
	<?php if (in_array('skype', $hiddenColumns)) echo "</div>"; ?>
