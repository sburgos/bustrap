...
if (!isset($formAction)) {
	if ($model->isNewRecord)
		$formAction = ['/bus/crud/agenda/create'];
	else {
		$formAction = ['/bus/crud/agenda/update'];
...
?>
	...
	<?php if (in_array('titulo', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'titulo')->textInput(['maxlength' => 200]) ?>
	<?php if (in_array('titulo', $hiddenColumns)) echo "</div>"; ?>

	<?php if (in_array('descripcion', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'descripcion')->textarea(['rows' => 6]) ?>
	<?php if (in_array('descripcion', $hiddenColumns)) echo "</div>"; ?>

	<?php if (in_array('lugar', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'lugar')->textInput(['maxlength' => 400]) ?>
	<?php if (in_array('lugar', $hiddenColumns)) echo "</div>"; ?>

	<?php if (in_array('desdeDate', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'desdeDate')->dateTimeInput() ?>
	<?php if (in_array('desdeDate', $hiddenColumns)) echo "</div>"; ?>

	<?php if (in_array('hastaDate', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'hastaDate')->dateTimeInput() ?>
	<?php if (in_array('hastaDate', $hiddenColumns)) echo "</div>"; ?>
