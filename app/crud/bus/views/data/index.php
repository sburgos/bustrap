...
/* @var $searchModel orm\bus\search\SearchData */
...
<div class="crud-page-header page-header">
	<div class="btn-group btn-group-sm" style="float:right;">
		<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_BUTTONS, new CrudEvent(['modelClass' => 'orm\bus\Data'])); ?>
...
<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_AFTER_GRID, new CrudEvent(['modelClass' => 'orm\bus\Data', 'dataProvider' => $dataProvider, 'columns' => $columns])); ?>
