...
/* @var $searchModel orm\bus\search\SearchSmartNode */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Smart Nodes';
...
<div class="crud-page-header page-header">
	<div class="btn-group btn-group-sm" style="float:right;">
		<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_BUTTONS, new CrudEvent(['modelClass' => 'orm\bus\SmartNode'])); ?>
...
<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_AFTER_GRID, new CrudEvent(['modelClass' => 'orm\bus\SmartNode', 'dataProvider' => $dataProvider, 'columns' => $columns])); ?>
