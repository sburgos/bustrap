...
$tabs = [
	...
	'view-datas' => ['label' => 'Tab: Smart Node: Datas', 'active' => false, 'visible' => true, 'url' => Url::toRoute(array_merge(['view-datas'], $_GET))],
	'view-smart-routes' => ['label' => 'Tab: Smart Node: Smart Routes', 'active' => false, 'visible' => true, 'url' => Url::toRoute(array_merge(['view-smart-routes'], $_GET))],
];
