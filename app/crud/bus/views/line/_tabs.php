...
$tabs = [
	...
	'view-buses' => ['label' => 'Tab: Line: Buses', 'active' => false, 'visible' => true, 'url' => Url::toRoute(array_merge(['view-buses'], $_GET))],
	'view-routes' => ['label' => 'Tab: Line: Routes', 'active' => false, 'visible' => true, 'url' => Url::toRoute(array_merge(['view-routes'], $_GET))],
];
