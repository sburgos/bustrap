...
if (!isset($formAction)) {
	if ($model->isNewRecord)
		$formAction = ['/bus/crud/smart-routes/create'];
	else {
		$formAction = ['/bus/crud/smart-routes/update'];
...
?>
	...
	<?php if (in_array('idRoute', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'idRoute')->widget(\common\yii\jui\AutoComplete::className(), [
			'crudUrl' => \yii\helpers\Url::toRoute(['/bus/crud/route']),
		]) ?>
	<?php if (in_array('idRoute', $hiddenColumns)) echo "</div>"; ?>
