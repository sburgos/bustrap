...
/* @var $searchModel orm\bus\search\SearchSmartRoutes */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Smart Routes';
...
<div class="crud-page-header page-header">
	<div class="btn-group btn-group-sm" style="float:right;">
		<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_BUTTONS, new CrudEvent(['modelClass' => 'orm\bus\SmartRoutes'])); ?>
...
<?php
	...
	Yii::$app->trigger(CrudEvent::RENDER_INDEX_BEFORE_GRID, new CrudEvent([
		'modelClass' => 'orm\bus\SmartRoutes', 
...
<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_AFTER_GRID, new CrudEvent(['modelClass' => 'orm\bus\SmartRoutes', 'dataProvider' => $dataProvider, 'columns' => $columns])); ?>
