...
/**
 * SearchRoleRestPermit represents the model behind the search form about `orm\admin\RoleRestPermit`.
 */
class SearchRoleRestPermit extends RoleRestPermit
{
	/**
    ...
    {
        return [
            [['id', 'roleRestId', 'priority'], 'integer'],
