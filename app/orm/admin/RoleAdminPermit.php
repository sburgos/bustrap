...
/**
 * This is the model class for table "usmp_admin.role_admin_permit".
 *
 * @property integer $id
 ...
 */
class RoleAdminPermit extends \yii\db\ActiveRecord
{
    ...
    {
        return 'usmp_admin.role_admin_permit';
    }
    ...
    public function rules()
    {
        return [
			...
			'required' => [['roleAdminId', 'regex', 'type'], 'required'],
			'integer' => [['roleAdminId', 'priority'], 'integer'],
			'string' => [['type'], 'string'],
    ...
    {
        return $this->hasOne(RoleAdmin::className(), ['id' => 'roleAdminId']);
    }
}
