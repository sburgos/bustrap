...
/**
 * This is the model class for table "usmp.admin_manager".
 *
 * @property integer $id
...
class AdminManager extends \yii\db\ActiveRecord
{
    ...
    {
        return [
			'required' => [['manageId', 'adminId'], 'required'],
			'integer' => [['manageId', 'adminId'], 'integer'],
    ...
    {
        return $this->hasOne(Manager::className(), ['id' => 'manageId']);
    }
