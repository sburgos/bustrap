...
$tabs = [
	...
	'view-assistants' => ['label' => 'Tab: Event: Assistants', 'active' => false, 'visible' => true, 'url' => Url::toRoute(array_merge(['view-assistants'], $_GET))],
	'view-prices' => ['label' => 'Tab: Event: Prices', 'active' => false, 'visible' => true, 'url' => Url::toRoute(array_merge(['view-prices'], $_GET))],
	'view-tickets' => ['label' => 'Tab: Event: Tickets', 'active' => false, 'visible' => true, 'url' => Url::toRoute(array_merge(['view-tickets'], $_GET))],
];
