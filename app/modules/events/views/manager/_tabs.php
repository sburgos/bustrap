...
$tabs = [
	...
	'view-admin-managers' => ['label' => 'Tab: Manager: Admin Managers', 'active' => false, 'visible' => true, 'url' => Url::toRoute(array_merge(['view-admin-managers'], $_GET))],
	'view-events' => ['label' => 'Tab: Manager: Events', 'active' => false, 'visible' => true, 'url' => Url::toRoute(array_merge(['view-events'], $_GET))],
];
