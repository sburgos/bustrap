...
/* @var $searchModel orm\event\search\SearchTicketPricePaid */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Ticket Price Paids';
...
<div class="crud-page-header page-header">
	<div class="btn-group btn-group-sm" style="float:right;">
		<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_BUTTONS, new CrudEvent(['modelClass' => 'orm\event\TicketPricePaid'])); ?>
...
<?php
	...
	Yii::$app->trigger(CrudEvent::RENDER_INDEX_BEFORE_GRID, new CrudEvent([
		'modelClass' => 'orm\event\TicketPricePaid', 
...
<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_AFTER_GRID, new CrudEvent(['modelClass' => 'orm\event\TicketPricePaid', 'dataProvider' => $dataProvider, 'columns' => $columns])); ?>
