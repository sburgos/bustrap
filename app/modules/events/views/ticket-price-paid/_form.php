...
if (!isset($formAction)) {
	if ($model->isNewRecord)
		$formAction = ['/event/crud/ticket-price-paid/create'];
	else {
		$formAction = ['/event/crud/ticket-price-paid/update'];
...
?>
	...
	<?php if (in_array('ticketPriceId', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'ticketPriceId')->widget(\common\yii\jui\AutoComplete::className(), [
			'crudUrl' => \yii\helpers\Url::toRoute(['/event/crud/ticket-price']),
		]) ?>
	<?php if (in_array('ticketPriceId', $hiddenColumns)) echo "</div>"; ?>

	<?php if (in_array('amount', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'amount')->textInput() ?>
	<?php if (in_array('amount', $hiddenColumns)) echo "</div>"; ?>

	<?php if (in_array('sharesNumber', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'sharesNumber')->textInput() ?>
	<?php if (in_array('sharesNumber', $hiddenColumns)) echo "</div>"; ?>

	<?php if (in_array('currency', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'currency')->dropDownList([
			\orm\event\TicketPricePaid::CURRENCY_SOLES => 'Soles',
			\orm\event\TicketPricePaid::CURRENCY_DOLARES => 'Dolares',
		], ['prompt' => '']) ?>
