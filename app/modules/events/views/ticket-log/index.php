...
/* @var $searchModel orm\event\search\SearchTicketLog */
...
<div class="crud-page-header page-header">
	<div class="btn-group btn-group-sm" style="float:right;">
		<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_BUTTONS, new CrudEvent(['modelClass' => 'orm\event\TicketLog'])); ?>
...
<?php
	...
	Yii::$app->trigger(CrudEvent::RENDER_INDEX_BEFORE_GRID, new CrudEvent([
		'modelClass' => 'orm\event\TicketLog', 
...
<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_AFTER_GRID, new CrudEvent(['modelClass' => 'orm\event\TicketLog', 'dataProvider' => $dataProvider, 'columns' => $columns])); ?>
