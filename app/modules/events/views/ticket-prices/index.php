...
/* @var $searchModel orm\event\search\SearchTicketPrices */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Ticket Prices';
...
<div class="crud-page-header page-header">
	<div class="btn-group btn-group-sm" style="float:right;">
		<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_BUTTONS, new CrudEvent(['modelClass' => 'orm\event\TicketPrices'])); ?>
...
<?php
	...
	Yii::$app->trigger(CrudEvent::RENDER_INDEX_BEFORE_GRID, new CrudEvent([
		'modelClass' => 'orm\event\TicketPrices', 
...
<?php Yii::$app->trigger(CrudEvent::RENDER_INDEX_AFTER_GRID, new CrudEvent(['modelClass' => 'orm\event\TicketPrices', 'dataProvider' => $dataProvider, 'columns' => $columns])); ?>
