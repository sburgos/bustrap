...
$tabs = [
	...
	'view-ticket-logs' => ['label' => 'Tab: Ticket: Ticket Logs', 'active' => false, 'visible' => true, 'url' => Url::toRoute(array_merge(['view-ticket-logs'], $_GET))],
	'view-ticket-prices' => ['label' => 'Tab: Ticket: Ticket Prices', 'active' => false, 'visible' => true, 'url' => Url::toRoute(array_merge(['view-ticket-prices'], $_GET))],
];
