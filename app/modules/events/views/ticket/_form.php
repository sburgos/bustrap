...
if (!isset($formAction)) {
	if ($model->isNewRecord)
		$formAction = ['/event/crud/ticket/create'];
	else {
		$formAction = ['/event/crud/ticket/update'];
...
?>
	...
	<?php if (in_array('asistantId', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
	...
	<?php if (in_array('asistantId', $hiddenColumns)) echo "</div>"; ?>

	<?php if (in_array('sellingDate', $hiddenColumns)) echo "<div style='display:none;'>"; ?>
		<?= $form->field($model, 'sellingDate')->dateTimeInput() ?>
	<?php if (in_array('sellingDate', $hiddenColumns)) echo "</div>"; ?>
