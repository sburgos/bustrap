...
use app\modules\events\models\UploadForm;
use Yii;
use orm\event\Event;
use orm\event\search\SearchEvent;
...
class EventController extends Controller
{
	...
	/**
	 * Tab for viewing Assistants for a single model
	 *
     * @param integer $id
     * @return mixed
	 */
	public function actionViewAssistants($id)
	{
		$model = $this->findModel($id);
		return $this->render('view-relation', [
            'model' => $model,
            'relationName' => 'Assistants',
            'refClass' => 'Assistant',
            'parentColumns' => ['eventId', 'event'],
            'refColumns' => [
    'eventId' => 'id',
],
            'dataProvider' => new \yii\data\ActiveDataProvider([
            	'query' => $model->getAssistants(),
            ]),
            'oneToOne' => false,
        ]);
	}
	...
	/**
	 * Tab for viewing Prices for a single model
	 *
     * @param integer $id
     * @return mixed
	 */
	...
	/**
	 * Tab for viewing Tickets for a single model
	 *
     * @param integer $id
     * @return mixed
	 */
	public function actionViewTickets($id)
	{
		$model = $this->findModel($id);
		return $this->render('view-relation', [
            'model' => $model,
    ...
    {
		$labelFields = explode(",", Event::$__AJAX_LABEL_FIELDS_COMMA_SEPARATED);
		$labelFormat = Event::$__AJAX_LABEL_FORMAT;
