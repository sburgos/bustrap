...
use Yii;
use orm\event\Price;
use orm\event\search\SearchPrice;
...
class PriceController extends Controller
{
	...
	/**
	 * Tab for viewing Shares for a single model
	 *
     * @param integer $id
     * @return mixed
	 */
    ...
    {
		$labelFields = explode(",", Price::$__AJAX_LABEL_FIELDS_COMMA_SEPARATED);
		$labelFormat = Price::$__AJAX_LABEL_FORMAT;
