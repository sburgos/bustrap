...
use Yii;
use orm\event\Share;
use orm\event\search\SearchShare;
...
class ShareController extends Controller
{
    ...
    {
		$labelFields = explode(",", Share::$__AJAX_LABEL_FIELDS_COMMA_SEPARATED);
		$labelFormat = Share::$__AJAX_LABEL_FORMAT;
