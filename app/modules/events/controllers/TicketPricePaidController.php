...
use orm\event\search\SearchTicketPricePaid;
...
/**
 * TicketPricePaidController implements the CRUD actions for TicketPricePaid model.
 */
class TicketPricePaidController extends Controller
{
    ...
    /**
     * Lists all TicketPricePaid models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new SearchTicketPricePaid();
    ...
    /**
     * Displays a single TicketPricePaid model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new TicketPricePaid model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new TicketPricePaid();
        ...
        if (Yii::$app->request->isPost) 
    	{
    		try
    		{
    			...
    			if ($model->load($post) && $model->save())
    			{
    				...
    				return $this->redirect(['view', 'id' => $model->ticketPriceId]);
    			}
    			else
    			{
    ...
    /**
     * Updates an existing TicketPricePaid model.
    ...
    /**
     * Deletes an existing TicketPricePaid model.
    ...
    /**
     * Finds the TicketPricePaid model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return TicketPricePaid the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = TicketPricePaid::findOne($id)) !== null) {
            return $model;
        } else {
    ...
    {
		$labelFields = explode(",", TicketPricePaid::$__AJAX_LABEL_FIELDS_COMMA_SEPARATED);
		$labelFormat = TicketPricePaid::$__AJAX_LABEL_FORMAT;
		
    	$rows = [];
    	if ($term !== null)
    	{
    		$qry = TicketPricePaid::find();
    		
    		$qry->orWhere('ticketPriceId=:ticketPriceId', [':ticketPriceId' => $term]);
