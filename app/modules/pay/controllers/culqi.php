...
class Pago
{
	...
	public static function crearDatospago($sp821fb9, $sp37cd46 = null)
	{
		...
		$spa944fe = array(Pago::PARAM_COD_COMERCIO => Culqi::$codigoComercio, Pago::PARAM_INFO_VENTA => $sp327f8d);
		$spd4bb0a = Pago::validateAuth($spa944fe);
		if ( ! empty($spd4bb0a) && array_key_exists(Pago::PARAM_TICKET, $spd4bb0a))
		{
			$spd3ecee = array(
				Pago::PARAM_COD_COMERCIO => $spd4bb0a[ Pago::PARAM_COD_COMERCIO ],
