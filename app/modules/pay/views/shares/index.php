	...
	<form id="prices-form" action="" method="post">
		...
		<div class="col-xs-12 step-one main-content">
			...
			<div class="user-data col-xs-12">
				...
				?>
				<div class="heading-title">Con tu <i>correo</i> y <i>teléfono</i> sabremos que pagos tienes pendientes para este evento.</div>
			...
			<div class="first-step buttonbar cp-button-group ">
				<div class="col-xs-5 col-left">
					<div class="btn-group btn-group-justified">
						<a tabindex="-1" data-toggle="modal" data-target="#cancelModal" class="btn btn-default btn-block" href="/pay?id=<?= $event->id ?>">
